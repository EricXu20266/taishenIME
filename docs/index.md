...
| Root | 手册 | 状态 |
|------|------|------|
| #1 数据模型与持久化 | [modules/data-persistence.md](modules/data-persistence.md) | ⏳ 待实现时补充 |
| #2 业务领域层 | [modules/pinyin-engine.md](modules/pinyin-engine.md) | ⏳ 待实现时补充 |
| #3 接口层 | [modules/interface-layer.md](modules/interface-layer.md) | ⏳ 待实现时补充 |
...
| #8 呈现层 | [modules/presentation.md](modules/presentation.md) | ⏳ 待实现时补充 |
